    ...
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    addAndMakeVisible(diffusionKnob.slider);
    diffusionKnob.slider.setLookAndFeel(&fxmeLookAndFeel);
    diffusionKnob.slider.onDragEnd = stopDrag;
    diffusionKnob.slider.onDragStart = startDrag;
...
void ReverbAudioProcessorEditor::resized()
{
    ...
    fb1.items.add(fi(diffusionKnob.flex()).withFlex(1.f));
    ...
    fb31.items.add(fi(fb311).withFlex(1.f).withMargin(juce::FlexItem::Margin(0.f,0.f,0.f,0.f)));
    fb31.items.add(fi(fb312).withFlex(0.25f).withMargin(juce::FlexItem::Margin(0.f,0.f,0.f,0.f)));
